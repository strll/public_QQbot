package com.mybatisplus.listener;
...
public class MyPrivateListen {
    ...
    public void replyPrivateMsg1(PrivateMsg privateMsg, Sender sender){
        ...
        String text = privateMsg.getText(); //尝试获取文本信息
        System.out.println("获取文本信息"+text);
        String id = privateMsg.getId();
        System.out.println("getId是"+id);
        System.out.println("privateMsg是"+privateMsg.toString());
        ...
        System.out.println("尝试打印消息主体"+msgContent);
        System.out.println("msgContent.toString()"+msgContent.toString());
